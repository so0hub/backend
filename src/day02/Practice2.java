...
결과: 210 */
        ...
        byte a = 10;
        int b = 200;
        long result1 = a+b; // byte + int = int(자동타입변환) -> long
...
변환된 int 값: 3 */
        // 2. 강제타입변환
        double z = 3.141592;  System.out.println("원본 double 값 : "+z);
        int result2 = (int)z;   System.out.println("변환된 int 값 : "+result2);
...
당신의 키는 약 178cm 이군요. */
    // 3. 변수 출력 시 타입변환
        ...
        System.out.println("당신의 키는 약 : " + (int)키+"cm 입니다.");
...
평균 결과: 17.666666666666668 */
        ...
        // 3은 int, 3.0은 double 주의☆ 나누기 3.0 해야 돼!!!

        // 가장 가까운 변수 출력 함수 : soutv 자동완성
