...
public class Exam1 {
    public static void main(String[] args) {
        ...
        // 2. 목적 : 클래스 정의할 때 멤버변수 *타입* 정하지 않고 인스턴스(객체) 생성할 때 타입 정한다.
        // 3. 사용법 :
        //    1. 제네릭타입명은 영문 대문자로 한다.
        //    2. 여러개 가능하다.
        //    3. 제네릭타입에 대입되는 타입은 기본타입 안 된다. < 래퍼클래스 사용 >
                // int -> Intenger

        // **DTO(Data Transfer Object)**를 통합할 때 잘쓰임 이거 나중에 검색.
        ...
        // box1.content = 100;          // 타입이 다른 멤버변수에는 값을 대입 불가능
        // box2.content = "안녕하세요";
        ...
        ArrayList<String> List1 = new ArrayList<>(); // ArrayList 안에서 제네릭타입을 String 타입으로 사용한다는뜻
        // ArrayList<Dto> List2 = new ArrayList<>(); // ArrayList 안에서 제네릭타입을 Dto 타입으로 사용한다는 뜻
