...
public class Exam4 { // class START
    public static void main(String[] args) { // main START
        ...
        // [2] 입력함수
        // 1. .next(); : 입력받은 자료들을 문자열(String)로 변환, 띄어쓰기 불가능
        ...
        // 주의할 점 : 띄어쓰기를 포함하다보니 앞전에 next() 와 충돌하여 하나의 next 인식된다
        ...
        // 4. .nextShort() : 입력받은 자료를 쇼트로 반환 , +-3만 정도 이외 자료이면 오류 발생
        System.out.print("4.nextShort() : ");
        short s1 = 입력변수.nextShort();
        System.out.println(s1);

        // 5. .nextInt() : 입력받은 자료를 인트로 반환 , +-21억정도 이의 자료이면 오류 발생
        ...
        // 10. next().charAT(0) : 입력받은 자료에서 첫 번째 글자 반환 , char 문자 스캔은 없다.
